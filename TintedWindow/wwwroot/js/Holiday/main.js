...
var canEdit = isEditHoliday;
var canDelete = isDeleteHoliday;
...
var edit = function (id) {
    if (id != "0") {
        ...
        $('#kt_modal_Holiday').find("#mainTitle").text(localizer["EditHoliday"]);
        $('#kt_modal_Holiday').find("#idHoliday").val(id);
        $('#kt_modal_Holiday').find("#description").val(item.find(".description").first().html());
        $('#kt_modal_Holiday').find("#holidaydate").val(item.find(".date").first().html());
    }
    else {
        $('#kt_modal_Holiday').find("#mainTitle").text(localizer["AddHoliday"]);
    }
    $('#kt_modal_Holiday').modal('show');
    document.getElementById("holidaydate").removeAttribute("inert");
}

var KTHolidayModel = function () {
    // Shared variables
    const element = document.getElementById('kt_modal_Holiday');
    const form = element.querySelector('#kt_modal_Holiday_form');
    ...
    var initHoliday = () => {
                ...
                fields: {
                    holidaydate: {
                        validators: {
                            ...
                            callback: {
                                message: localizer["Holidaydate"] + " " + localizer["isRequired"],
        ...
        const submitButton = element.querySelector('[data-kt-Holiday-modal-action="submit"]');
        submitButton.addEventListener('click', e => {
            e.preventDefault();
            document.getElementById("holidaydate").setAttribute("inert", "");
        ...
        const cancelButton = element.querySelector('[data-kt-Holiday-modal-action="cancel"]');

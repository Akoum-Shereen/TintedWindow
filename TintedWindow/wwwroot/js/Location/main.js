...
var canEdit = isEditLocation;
var canDelete = isDeleteLocation;
...
var edit = function (id) {
    if (id != "0") {
        ...
        $('#kt_modal_Location').find("#mainTitle").text(localizer["EditLocation"]);
        $('#kt_modal_Location').find("#idlocation").val(id);
        $('#kt_modal_Location').find("#title").val(item.find(".title").first().html());
    }
    else {
        $('#kt_modal_Location').find("#mainTitle").text(localizer["AddLocation"]);
    }
    $('#kt_modal_Location').modal('show');
}

var KTLocationModel = function () {
    // Shared variables
    const element = document.getElementById('kt_modal_Location');
    const form = element.querySelector('#kt_modal_Location_form');
    ...
    var initLocation = () => {
        ...
        const submitButton = element.querySelector('[data-kt-Location-modal-action="submit"]');
            ...
            if (validator) {
                validator.validate().then(function (status) {
                    ...
                    if (status == 'Valid') {
                        ...
                        var action = "Location/Create";

                        if ($('#idlocation').val() != "") {
                            ob.idlocation = $('#idlocation').val();

...
var canEdit = isEditCounter;
var canDelete = isDeleteCounter;
...
var edit = function (id) {
    if (id != "0") {
        ...
        $('#kt_modal_Counter').find("#mainTitle").text(localizer["EditCounter"]);
        $('#kt_modal_Counter').find("#idcounter").val(id);
        $('#kt_modal_Counter').find("#title").val(item.find(".title").first().html());
    }
    else {
        $('#kt_modal_Counter').find("#mainTitle").text(localizer["AddCounter"]);
    }
    $('#kt_modal_Counter').modal('show');
}

var KTCounterModel = function () {
    // Shared variables
    const element = document.getElementById('kt_modal_Counter');
    const form = element.querySelector('#kt_modal_Counter_form');
            ...
            if (validator) {
                validator.validate().then(function (status) {
                    ...
                    if (status == 'Valid') {
                        ...
                        var action = "Counter/Create";

                        if ($('#idcounter').val() != "") {
                            ob.idcounter = $('#idcounter').val();
                            action = "Counter/Edit"
                        }

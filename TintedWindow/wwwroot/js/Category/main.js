...
var canEdit = isEditCategory;
var canDelete = isDeleteCategory;
...
var edit = function (id) {
    if (id != "0") {
        ...
        $('#kt_modal_Category').find("#mainTitle").text(localizer["EditCategory"]);
        $('#kt_modal_Category').find("#idCategory").val(id);
        $('#kt_modal_Category').find("#title").val(item.find(".title").first().html());
    }
    else {
        $('#kt_modal_Category').find("#mainTitle").text(localizer["AddCategory"]);
    }
    $('#kt_modal_Category').modal('show');
}

var KTCategoryModel = function () {
    // Shared variables
    const element = document.getElementById('kt_modal_Category');
    const form = element.querySelector('#kt_modal_Category_form');

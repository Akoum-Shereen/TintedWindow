...
{
    [Authorize]
    public class AnnouncementController : SharedController
    {
        ...
        public AnnouncementController(
           ILogger<AnnouncementController> logger, IConfiguration iconfig, IStringLocalizer<SharedResource> localizer,
        ...
        {
            ViewData["Title"] = _localizer["Announcement"];
        ...
        {
            _logger.LogInformation("->>>>>>>>>Announcement List  url>>>>>>>>>>>");

            string url = "";

            var ApiPreff = _configuration.GetValue<string>("MyConfiguration:ApiPreff");
            url = ApiPreff + "Announcement/Get";
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<dynamic> Create(AnnouncementReq obj)
        {
            var ApiPreff = _configuration.GetValue<string>("MyConfiguration:ApiPreff");
            string url = ApiPreff + "Announcement/Add";
        ...
        public async Task<IActionResult> Edit(string id = null)
        {
            ...
            var ApiPreff = _configuration.GetValue<string>("MyConfiguration:ApiPreff");
            string url = ApiPreff + "Announcement/GetById";
            var obj = new AnnouncementReqDelete()
            {
                idads = id
            };
            ...
            {
                case 0:
                    ViewData["Info"] = res.announcementbyid;
                    return View("Create");
                case 402:
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<dynamic> Edit(AnnouncementReqUpdate obj)
        {
            dynamic res = "";

            var ApiPreff = _configuration.GetValue<string>("MyConfiguration:ApiPreff");
            string url = ApiPreff + "Announcement/Update";
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<dynamic> Delete(AnnouncementReqDelete obj)
        {
            var ApiPreff = _configuration.GetValue<string>("MyConfiguration:ApiPreff");
            string url = ApiPreff + "Announcement/Delete";
            var res = await PostCall(url, obj, null, true, true);

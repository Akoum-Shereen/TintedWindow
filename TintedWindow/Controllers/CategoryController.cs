...
namespace TintedWindow.Controllers.UserManagement
{
    ...
    public class CategoryController : SharedController
    {
        ...
        public CategoryController(
           ILogger<CategoryController> logger, IConfiguration iconfig, IStringLocalizer<SharedResource> localizer,
        ...
        {
            ViewData["Title"] = _localizer["Category"];
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<dynamic> Create(CategoryReq obj)
        {
            var ApiPreff = _configuration.GetValue<string>("MyConfiguration:ApiPreff");
            string url = ApiPreff + "Category/Add";
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<dynamic> Edit(CategoryReqUpdate obj)
        {
            dynamic res = "";

            var ApiPreff = _configuration.GetValue<string>("MyConfiguration:ApiPreff");
            string url = ApiPreff + "Category/Update";
        ...
        [HttpPost]
        public async Task<dynamic> UpdateOrder(CategoryReqOrder obj)
        {
            var ApiPreff = _configuration.GetValue<string>("MyConfiguration:ApiPreff");
            string url = ApiPreff + "CategoryOrder/Update";
            var res = await PostCall(url, obj, null, true, true);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<dynamic> Delete(CategoryReqDelete obj)
        {
            var ApiPreff = _configuration.GetValue<string>("MyConfiguration:ApiPreff");
            string url = ApiPreff + "Category/Delete";
            var res = await PostCall(url, obj, null, true, true);

...
{
    [Authorize]
    public class HolidayController : SharedController
    {
        ...
        public HolidayController(
           ILogger<HolidayController> logger, IConfiguration iconfig, IStringLocalizer<SharedResource> localizer,
        ...
        {
            ViewData["Title"] = _localizer["Holiday"];
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<dynamic> Create(HolidayReq obj)
        {
            var ApiPreff = _configuration.GetValue<string>("MyConfiguration:ApiPreff");
            string url = ApiPreff + "Holiday/Add";
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<dynamic> Edit(HolidayReq obj)
        {
            dynamic res = "";

            var ApiPreff = _configuration.GetValue<string>("MyConfiguration:ApiPreff");
            string url = ApiPreff + "Holiday/Update";
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<dynamic> Delete(HolidayDelete obj)
        {
            var ApiPreff = _configuration.GetValue<string>("MyConfiguration:ApiPreff");
            string url = ApiPreff + "Holiday/Delete";
            var res = await PostCall(url, obj, null, true, true);

...
{
    [Authorize]
    public class LocationController : SharedController
    {
        ...
        public LocationController(
           ILogger<LocationController> logger, IConfiguration iconfig, IStringLocalizer<SharedResource> localizer,
        ...
        {
            ViewData["Title"] = _localizer["Location"];
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<dynamic> Create(LocationReq obj)
        {
            var ApiPreff = _configuration.GetValue<string>("MyConfiguration:ApiPreff");
            string url = ApiPreff + "Location/Add";
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<dynamic> Edit(LocationReqUpdate obj)
        {
            dynamic res = "";

            var ApiPreff = _configuration.GetValue<string>("MyConfiguration:ApiPreff");
            string url = ApiPreff + "Location/Update";
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<dynamic> Delete(LocationReqDelete obj)
        {
            var ApiPreff = _configuration.GetValue<string>("MyConfiguration:ApiPreff");
            string url = ApiPreff + "Location/Delete";
            var res = await PostCall(url, obj, null, true, true);
